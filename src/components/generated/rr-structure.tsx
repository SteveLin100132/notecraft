...
// -----------------------------------------------------------------------
// R&R — Waterfall 指揮鏈 vs Scrum 自組織圈（互動結構對照）
...
function ColHead({
  ...
  return (
    <div style={{ marginBottom: 8 }}>
      ...
      <div
        style={{ fontSize: 14.5, fontWeight: 800, color: "var(--neutral-700)" }}
      >
        {zh}
      </div>
    </div>
    ...
    >
      ...
      >
        ...
        <div
          style={{
            paddingRight: 22,
            borderRight: "2px dashed var(--neutral-200)",
          }}
        >
          <ColHead
            en="WATERFALL"
        ...
        {/* RIGHT — scrum (self-organizing circle) */}
        <div style={{ paddingLeft: 22 }}>
          ...
          <Foot>
            團隊在中央自組織；PO 餵養方向、SM 移除障礙，都是「服務」。
          </Foot>
        </div>
      </div>
      ...
      >
        {cur ? (
            ...
            >
              <span
                style={{
                  ...
                  borderRadius: "var(--radius-pill)",
                  background:
                    cur.side === "wf" ? "var(--blue-50)" : "var(--orange-50)",
                  color:
                    cur.side === "wf" ? "var(--blue-700)" : "var(--orange-500)",
                }}
              >
                {cur.side === "wf" ? "WATERFALL" : "SCRUM"}
              </span>
              <span
                style={{
                  fontSize: 17,
          ...
          >
            <Sparkles
              size={17}
              style={{ color: "var(--orange-500)", flexShrink: 0 }}
            />
            點選任一角色查看完整職責 ——
            注意左欄箭頭一路向下（指派），右欄箭頭向內（服務）。
          </div>
        )}
      </div>
    </figure>
