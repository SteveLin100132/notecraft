...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    id: 2,
    title: '專案管理方法論',
    insight: '知道在管什麼之後，才挑 Waterfall 還是 Agile 來執行。',
    points: [
      'SDLC 把工作拆成明確階段',
...
function getChapterColors(id: number, unlocked: boolean, active: boolean): ChapterColors {
  if (!unlocked) {
    return {
  ...
  if (id <= 2) {
    return {
      nodeRing: active ? 'border-[var(--blue-700)]' : 'border-[var(--blue-300)]',
  ...
  return {
    nodeRing: active ? 'border-[var(--orange-500)]' : 'border-[var(--orange-300)]',
          ...
          <div
            ...
            style={{
              ...
              background: unlocked
                ...
                : 'var(--neutral-200)',
              backgroundColor: unlocked ? colors.connectorColor : 'var(--neutral-200)',
            }}
          />
        )}
      </div>
      ...
      <div className="flex-1 ml-3 mb-4">
        ...
        <button
          ...
          className={clsx(
            ...
            expanded
              ? clsx('border-[var(--border-brand)] bg-[var(--surface-card)]', 'shadow-sm')
              : unlocked
            ...
            <div className="min-w-0">
              ...
              <p
                className={clsx(
                  ...
                  unlocked ? 'text-[var(--text-strong)]' : 'text-[var(--text-muted)]',
                )}
              >
                {chapter.title}
              </p>
            ...
            >
              <div className="px-4 pt-3 pb-1 flex flex-col gap-3">
                ...
                >
                  ...
                  />
                  <div>
                    <p className={clsx('text-[10px] font-semibold mb-0.5', colors.accentText)}>
                      讀完你會
                    </p>
                    <p className={clsx('text-sm leading-relaxed', colors.accentText)}>
                      {chapter.outcome}
                    </p>
                  </div>
                </div>
